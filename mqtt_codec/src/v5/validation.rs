...
mod tests {
    ...
    fn test_validate_reason_code_connack() {
        ...
        assert!(validate_reason_code_for_packet(ReasonCode::GrantedQoS1, PacketType::ConnAck).is_err());
    }
    ...
    fn test_validate_reason_code_auth() {
        assert!(validate_reason_code_for_packet(ReasonCode::ContinueAuthentication, PacketType::Auth).is_ok());
        assert!(validate_reason_code_for_packet(ReasonCode::UnspecifiedError, PacketType::Auth).is_err());
    }
